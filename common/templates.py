...
def get_fine_community_item(request_user, community, item):
    if item.is_deleted():
...
def get_fine_user_item(request_user, item):
    if item.is_deleted():
...
def get_template_community_item(item, folder, template, request_user, user_agent, staff):
    ...
    if request_user.type[0] == "_":
        ...
        template_name = get_fine_community_item(request_user, community, item)
...
def get_template_user_item(item, folder, template, request_user, user_agent, staff):
    ...
    if request_user.type[0] == "_":
        ...
        template_name = get_fine_user_item(request_user, item)
