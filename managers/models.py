...
class Moderated(models.Model):
    ...
    def get_blog(self, user):
        ...
        return ''.join(['<div class="pag mt-2" obj-pk="', str(self.pk), '" data-pk="', str(self.object_id), '" style="position: relative;"><div class="d-flex justify-content-start align-items-center mb-1"><div class="avatar mr-1"><a href="/blog/', str(blog.slug), '/" class="ajax"><img src="', blog.get_image(), '" alt="avatar img" height="40" width="40"></a></div><div class="profile-user-info"><a href="/blog/', str(blog.slug), '/" class="ajax"><h4 class="mb-0">', blog.title, ' <span class="text-muted small">(', blog.get_created(), ')</span></h4></a><span class="small"><a href="/users/', str(creator.pk), '">', creator.get_full_name(),'</a></span></div></div><p class="card-text mb-50">', blog.description, '</p><span><span><span><span class="small" data-pk="', str(blog.pk), '"><span class="create_blog_close pointer underline">Заблокировать</span>&nbsp;&nbsp;<span class="create_blog_rejected pointer underline">Отклонить</span></span></span></span></span></div>'])
        #except:
        #    return ''
    ...
    def get_blog_comment(self, user):
        try:
            ...
            if comment.attach:
                ...
                _attach = ''
            return ''.join(['<div class="pag mt-2" obj-pk="', str(self.pk), '" data-pk="', str(self.object_id), '" style="position: relative;"><div class="card-body" style="padding: .5rem .5rem;"><div class="media"><div class="avatar mr-75"><a href="/users/', str(creator.pk), '/" class="ajax"><img src="', creator.get_avatar(), '" width="38" height="38" alt="Avatar"></a></div><div class="media-body"><h6 class="font-weight-bolder mb-25"><a href="/users/', str(creator.pk), '/" class="ajax">', creator.get_full_name(), '</a></h6><span class="text-muted small">', comment.get_created(), '</span><br></div></div><div class="comment_footer"><span class="card-text">', comment.text, '</span>', _attach, ' <span><div class="border mt-1 btn_console" data-pk="', str(comment.pk), '"><a " obj-pk="', str(self.pk), '" class="show_object_reports pointer">', self.reports_count_ru(), '</a> | <a class="create_blog_comment_close pointer">Закрыть</a> | <a class="create_blog_comment_rejected pointer">Отклонить</a></div></span></div></div></div>'])
        except:
            return ''
...
class ModerationReport(models.Model):
    ...
    def create_moderation_report(cls, reporter_id, _type, object_id, description, type):
        ...
        if moderated_object.reports_count() >= 100:
            return
...
class ModerationPenalty(models.Model):
    ...
    def get_blog(self, user):
        try:
            ...
            blog = Blog.objects.get(pk=self.object_id)
            creator = blog.creator
            return ''.join(['<div class="pag" data-pk="', str(blog.pk),'"><div class="d-flex justify-content-start align-items-center mb-1"><div class="avatar mr-1"><a href="/elect/new/', str(blog.pk), '/" class="ajax"><img src="', creator.get_avatar(), '" alt="avatar img" height="40" width="40"></a></div><div class="profile-user-info"><a href="/elect/new/', str(blog.pk), '/" class="ajax"><h4 class="mb-0">', blog.title, ' <span class="text-muted small">(', new.get_created(), ')</span></h4></a><span class="small">',blog.get_type_display(),'</span></div></div><p class="card-text mb-50">', blog.description, '</p><span class="small" data-pk="', str(blog.pk), '"><span class="remove_blog_close pointer underline">Восстановить</span>&nbsp;&nbsp;<span class="blog_unverify pointer underline">Отменить проверку</span></span></div>'])
        except:
            return ''
    def get_blog_comment(self, user):
        try:
            ...
            if comment.attach:
                ...
                _attach = ''
            return ''.join(['<div class="pag" data-pk="', str(comment.pk),'"><div class="card-body" style="padding: .5rem .5rem;"><div class="media"><div class="avatar mr-75"><a href="/users/', str(creator.pk), '/" class="ajax"><img src="', creator.get_avatar(), '" width="38" height="38" alt="Avatar"></a></div><div class="media-body"><h6 class="font-weight-bolder mb-25"><a href="/users/', str(creator.pk), '/" class="ajax">', creator.get_full_name(), '</a></h6><span class="text-muted small">', comment.get_created(), '</span><br></div></div><div class="comment_footer"><span class="card-text">', comment.text, '</span>', _attach, ' <div class="border mt-1 btn_console" data-pk="', str(comment.pk), '"><a class="remove_blog_comment_close pointer">Восстановить</a> | <a class="blog_comment_unverify pointer">Отменить проверку</a></div></div></div></div>'])
        except:
            return ''
    def get_elect_new(self, user):
        try:
            ...
            new = ElectNew.objects.get(pk=self.object_id)
            creator = new.creator
            return ''.join(['<div class="pag" data-pk="', str(new.pk),'"><div class="d-flex justify-content-start align-items-center mb-1"><div class="avatar mr-1"><a href="/elect/new/', str(new.pk), '/" class="ajax"><img src="', creator.get_avatar(), '" alt="avatar img" height="40" width="40"></a></div><div class="profile-user-info"><a href="/elect/new/', str(new.pk), '/" class="ajax"><h4 class="mb-0">', new.title, ' <span class="text-muted small">(', new.get_created(), ')</span></h4></a><span class="small">',new.get_type_display(),'</span></div></div><p class="card-text mb-50">', new.description, '</p><span class="small" data-pk="', str(new.pk), '"><span class="remove_elect_new_close pointer underline">Восстановить</span>&nbsp;&nbsp;<span class="elect_new_unverify pointer underline">Отменить проверку</span></span></div>'])
        except:
            return ''
    def get_elect_new_comment(self, user):
        try:
            ...
            if comment.attach:
                ...
                _attach = ''
            return ''.join(['<div class="pag" data-pk="', str(comment.pk),'"><div class="card-body" style="padding: .5rem .5rem;"><div class="media"><div class="avatar mr-75"><a href="/users/', str(creator.pk), '/" class="ajax"><img src="', creator.get_avatar(), '" width="38" height="38" alt="Avatar"></a></div><div class="media-body"><h6 class="font-weight-bolder mb-25"><a href="/users/', str(creator.pk), '/" class="ajax">', creator.get_full_name(), '</a></h6><span class="text-muted small">', comment.get_created(), '</span><br></div></div><div class="comment_footer"><span class="card-text">', comment.text, '</span>', _attach, ' <div class="border mt-1 btn_console" data-pk="', str(comment.pk), '"><a class="remove_elect_new_comment_close pointer">Восстановить</a> | <a class="elect_new_comment_unverify pointer">Отменить проверку</a></div></div></div></div>'])
        except:
            return ''
    def get_doc(self):
        try:
