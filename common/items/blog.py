...
def blog(user, blog):
    ...
    <span class="repost_count margin_right_5">', str(blog.count_reposts()), '</span></span><div class="dropdown-menu" style="top: -155px;" data-pk="', str(blog.pk), '" data-link="/blog/', blog.slug,'" data-title="', blog.title,'"><span class="dropdown-header" style="font-weight:bold">Поделиться</span><span class="dropdown-item blog_share_vkontakte">VKontakte</span><span class="dropdown-item blog_share_facebook">Facebook</span><span class="dropdown-item blog_share_twitter">Twitter</span><span class="dropdown-item blog_share_telegram">Telegram</span></div></span><span ', comments_enabled, '  title="Комментарий" class="btn_default" style="cursor:pointer;margin-right: 5px;">\
