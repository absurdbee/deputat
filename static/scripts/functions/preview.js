...
function create_preview_playlist(name, pk, count){
  ...
  $div_svg.classList.add("card-img-top", "file-logo-wrapper");
  $div_svg.style.padding = "2rem";
  $div_svg.innerHTML = '<a class="nowrap"><div class="d-flex align-items-center justify-content-center w-100 u_load_music_list pointer"><svg width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-play"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg></div></a>'

  $card_body = document.createElement("div");
  $card_body.classList.add("card-body", "pt-0");
  $card_body.innerHTML = '<div class="content-wrapper" style="display: flex;"><p class="card-text file-name mb-0 u_load_music_list pointer"><a class="nowrap">' + name + ' (' + count + ')</a></p></div><small class="file-accessed pointer doc_attach_list_remove underline">Открепить</small>'
