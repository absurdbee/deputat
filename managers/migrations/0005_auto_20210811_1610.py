...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('managers', '0004_auto_20210609_1738'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='type',
            field=models.CharField(choices=[('USE', 'Пользователь'), ('COM', 'Сообщество'), ('MUL', 'Плейлист'), ('MUS', 'Трек'), ('SUL', 'Список опросов'), ('SUR', 'Опрос'), ('ELE', 'Активность депутата'), ('ELEC', 'Коммент к активности депутата'), ('BLO', 'Блог'), ('BLOC', 'Коммент к блогу'), ('ORG', 'Организация'), ('ORGC', 'Коммент к организации'), ('DOL', 'Список документов'), ('DOC', 'документ'), ('PHL', 'Список фотографий'), ('PHO', 'Фотография'), ('PHOC', 'Коммент к фотографии'), ('VIL', 'Список роликов'), ('VID', 'Ролик'), ('VIDC', 'Коммент к ролику')], max_length=5, verbose_name='Класс объекта'),
        ),
        migrations.AlterField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='organization_user_staff', to=settings.AUTH_USER_MODEL, verbose_name='Особый пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='CanWorkStaffOrganizationUser',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='can_work_staff_organization_user', to=settings.AUTH_USER_MODEL, verbose_name='Создатель персонала в аудиозаписях')),
            ],
            options={
