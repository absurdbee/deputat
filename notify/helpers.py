ITEM, SUGGEST_ITEM, ELECT_NEW_CONFIRMED = "ITE", "SIT", "ELNC"
...
INERT, WOMEN_INERT, GROUP_INERT = 'INE', 'WINE', 'GINE'
...
VERB = (
    (ITEM, ' разместил'), (ELECT_NEW_CONFIRMED, 'Ваша новость опубликована'),
