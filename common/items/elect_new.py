...
def elect_new(user, elect_new):
    ...
    <br><a class="mt-1 ajax" style="text-decoration:underline" href="/elect/' + post.elect.pk + '">' + post.elect.name + '</a><div class="" style="padding: 5px;position: absolute;bottom: 3px;width: 100%;">\
