...
class Moderated(models.Model):
    ...
    def get_elect_new(self, user):
        try:
            ...
            creator = new.creator
            return ''.join(['<div class="d-flex justify-content-start align-items-center mb-1"><div class="avatar mr-1"><a href="/elect/new/', str(new.pk), '/" class="ajax"><img src="', new.get_image(), '" alt="avatar img" height="40" width="40"></a></div><div class="profile-user-info"><a href="/elect/new/', str(new.pk), '/" class="ajax"><h4 class="mb-0">', new.title, ' <span class="text-muted small">(new.get_created())</span></h4></a><span class="small"><a class="ajax" href="/users/',new.creator.pk(),'/">',new.creator.get_full_name(),'</a></span></div></div><p class="card-text mb-50">', new.description, '</p><span class="small" data-pk="', str(new.pk), '"><span " obj-pk="', str(self.pk), '" class="underline show_object_reports pointer">', self.reports_count_ru(), '</span>&nbsp;&nbsp;<span class="create_elect_new_close pointer underline">Заблокировать</span>&nbsp;&nbsp;<span class="create_elect_new_rejected pointer underline">Отклонить</span></span>'])
        except:
            return ''
    ...
    def get_elect_new_comment(self, user):
        try:
            ...
            if comment.attach:
                ...
                _attach = ''
            return ''.join(['<div class="card-body" style="padding: .5rem .5rem;"><div class="media"><div class="avatar mr-75"><a href="/users/', str(creator.pk), '/" class="ajax"><img src="', creator.get_avatar(), '" width="38" height="38" alt="Avatar"></a></div><div class="media-body"><h6 class="font-weight-bolder mb-25"><a href="/users/', str(creator.pk), '/" class="ajax">', creator.get_full_name(), '</a></h6><span class="text-muted small">', comment.get_created(), '</span><br></div></div><div class="comment_footer"><span class="card-text">', comment.text, '</span>', _attach, ' <div class="border mt-1 btn_console" data-pk="', str(comment.pk), '"><a " obj-pk="', str(self.pk), '" class="show_object_reports pointer">', self.reports_count_ru(), '</a> | <a class="create_elect_new_comment_close pointer">Закрыть</a> | <a class="create_elect_new_comment_rejected pointer">Отклонить</a></div></div></div>'])
        except:
            return ''
