...
class Elect(models.Model):
    ...
    vk = models.CharField(max_length=100, blank=True, verbose_name='Ссылка на VK')
    fb = models.CharField(max_length=100, blank=True, verbose_name='Ссылка на Facebook')
    ig = models.CharField(max_length=100, blank=True, verbose_name='Ссылка на Instagram')
    tg = models.CharField(max_length=100, blank=True, verbose_name='Ссылка на Telegram')
    tw = models.CharField(max_length=100, blank=True, verbose_name='Ссылка на Twitter')
