...
def wall_elect_new(user, elect_new):
    ...
    <br><br><a class="mt-1 ajax" style="text-decoration:underline" href="/elect/' + str(elect_new_pk) + '">' + elect_new.elect.name + '</a><div class="" style="padding: 5px;position: absolute;bottom: 3px;width: 100%;">\
