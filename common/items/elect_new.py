...
def elect_new(user, elect_new):
    ...
    <span class="repost_count margin_right_5">', str(elect_new.count_reposts()), '</span></span><span ', comments_enabled, ' title="Комментарий" class="btn_default" style="cursor:pointer;margin-right: 5px;">\
