  ...
  ajax_link = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject( 'Microsoft.XMLHTTP' );
    ...
    ajax_link.onreadystatechange = function () {
      if ( this.readyState == 4 && this.status == 200 ) {
        ...
        p.innerHTML = "<span style='width:100%' class='" + _class + " pointer border p-1' data-pk='" + item.getAttribute("data-pk") + "'>" + title + ". <span class='underline'>Восстановить</span></span>";
...
function check_message_form_btn() {
  ...
  input = btn_block.querySelector(".message_text");
