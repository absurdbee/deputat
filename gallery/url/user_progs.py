...
urlpatterns=[
    ...
    url(r'^add_photo_in_media_list/(?P<uuid>[0-9a-f-]+)/$', AddPhotoInUserMediaList.as_view()),
    url(r'^remove_photo_from_media_list/(?P<uuid>[0-9a-f-]+)/$', RemovePhotoInUserMediaList.as_view()),
