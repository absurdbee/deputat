...
def blog(user, blog):
    ...
    return ''.join([block, '<div class="event_card" data-pk="' + str(blog.pk) + '"><div class="event_img text-center"><a class="ajax" href="' + blog_url + '">\
    <img class="img-fluid card-img-top" src="' + blog.get_image() + '" alt="img"></a></div><div class="card-body event_body">\
    <h4 class="event_name"><div style="display: flex;"><a class="text-body ajax" href="' + blog_url + '">' + blog.title + '</a>\
    ...
    ' + blog.get_created() + ' | ' + tags + '</span></h4><div class="card-text event_description">' + blog.description + '\
    ...
    <span class="inerts_count margin_right_5">', str(blog.inerts_count()), '</span></span><span title="Поделиться" class="btn_default pointer get_blog_repost">\
    ...
    <span class="repost_count margin_right_5">', str(blog.reposts_count()), '</span></span><span title="Комментарий" class="btn_default" style="cursor:pointer;margin-right: 5px;">\
