...
on('body', 'click', '.track_load_several', function() {
  ...
  if (document.body.querySelector(".current_file_dropdown")){
    ...
    check_track_in_block(document.body.querySelector(".message_attach_block"), _this, pk) ? null : (music_message_attach(document.body.querySelector(".message_attach_block"), _this), this.classList.add("active_svg"))
  }
});
