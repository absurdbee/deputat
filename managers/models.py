...
class Moderated(models.Model):
    ...
    def get_user(self, user_id):
        try:
            ...
            '<div class="">', reports, '</div><div class="border-top btn_console" data-pk="', str(user_id), '"><a class="create_user_suspend pointer">Заморозить</a> | <a class="create_user_close pointer">Заблокировать</a> | <a class="create_user_warning_banner pointer">Повесить баннер</a> | <a class="create_user_rejected pointer">Отклонить</a></div></div></div>'])
        except:
