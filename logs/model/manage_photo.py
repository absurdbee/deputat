...
class PhotoManageLog(models.Model):
    LIST_CREATED, LIST_EDITED, LIST_CLOSED, ITEM_CLOSED, COMMENT_CLOSED = 'LCRE','LEDI','LCLO','ICLO','CCLO'
    ...
    ACTION_TYPES = (
        (LIST_CREATED, 'Список создан'),(LIST_EDITED, 'Список изменен'),(LIST_CLOSED, 'Список закрыт'),(ITEM_CLOSED, 'Элемент закрыт'),(COMMENT_CLOSED, 'Комментарий закрыт'),
