...
class Chat(models.Model):
    ...
    def get_preview_message(self, user_id):
        ...
        if self.is_group() or self.is_public():
            ...
            media_body = ''.join(['<div class="media-body" style="margin-left:5px"><h5 class="time-title mb-0">', chat_name, request_chat_user.get_beep_icon(), '<small class="float-right text-muted">', created, '</small></h5><p class="mb-0', is_read ,'" style="white-space: nowrap;">', preview_text, '</p></div>'])
