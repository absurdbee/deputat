...
def blog(user, blog):
    ...
    <span class="repost_count margin_right_5">', str(blog.reposts_count()), '</span></span><span ', comments_enabled, '  title="Комментарий" class="btn_default" style="cursor:pointer;margin-right: 5px;">\
